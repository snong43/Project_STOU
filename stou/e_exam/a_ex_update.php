...
<div class="container">
<form class="form-horizontal" action="./a_exam_insert_db.php" method="post">
    ...
    <div class="panel panel-primary">
      ...
      <div class="panel-body">
        <div class="form-group">
            ...
            <div class="col-sm-10">
              <textarea class="form-control" rows="2" id="ex0" name="ex0" tyle="background-color:#fefbd8;" required></textarea>
            </div>
            </div>
            <div class="form-group">
...
?>
<span class="pull-right">STOU.36 <?php echo $space ?></span>
